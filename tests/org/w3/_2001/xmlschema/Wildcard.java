 ...
 *       &lt;attGroup ref="{http://www.w3.org/2001/XMLSchema}anyAttrGroup"/>
    ...
    extends Annotated
{
    ...
    @XmlAttribute(name = "notNamespace")
    protected List<String> notNamespace;
    ...
    /**
     * Gets the value of the notNamespace property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the notNamespace property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNotNamespace().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getNotNamespace() {
        if (notNamespace == null) {
            notNamespace = new ArrayList<String>();
        }
