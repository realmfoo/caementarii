    ...
    extends Annotated
{
    ...
    protected List<AltType> alternative;
    @XmlElementRefs({
    ...
    protected List<QName> substitutionGroup;
     ...
     * 
     */
    public List<AltType> getAlternative() {
        if (alternative == null) {
            alternative = new ArrayList<AltType>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the substitutionGroup property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSubstitutionGroup().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<QName> getSubstitutionGroup() {
        if (substitutionGroup == null) {
            substitutionGroup = new ArrayList<QName>();
        }
